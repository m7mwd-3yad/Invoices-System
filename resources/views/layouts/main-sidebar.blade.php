        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('invoices.paid') }}">الفواتير المدفوعة</a>



                    </li>

                    <li><a class="slide-item" href="{{ route('invoices.unpaid') }}">الفواتير
                            الغير مدفوعة</a>
                    </li>

                    <li><a class="slide-item" href="{{ route('invoices.partial.paid') }}">الفواتير المدفوعة
                            جزئيا</a>
                    </li>
            ...
            <li class="side-item side-item-category"> الصلاحيات والمستخدمين</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('permission.index') }}">قائمة الصلاحيات</a></li>

                    <li><a class="slide-item" href="{{ route('role.index') }}"> قائمة الادوار</a></li>
                    <li><a class="slide-item" href="{{ route('add.role.permission') }}">اضافة الادوار الي
                            الصلاحيات</a></li>
                    <li><a class="slide-item" href="{{ route('all.role.permission') }}">الادور والصلاحيات</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('admin.index') }}">قائمة المستخدمين</a></li>

                    <li><a class="slide-item" href="{{ route('admin.create') }}"> اضافة المستخدمين</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('section.index') }}">الاقسام</a></li>
