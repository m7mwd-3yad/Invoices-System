                    ...
                    <form class="forms-sample" method="POST" action="{{ route('permission.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="permission_name"
                                ...
                                id="permission_name" placeholder="الصلاحية">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="group_name" class="form-control"id="exampleFormControlSelect1">
                                ...
                                <option value="Type">الفواتير</option>
                                <option value="Amenities">المستخدمين</option>
                                <option value="Amenities">المنتجات</option>
                                <option value="Amenities">الاقسام</option>
                                <option value="Amenities">التقارير</option>
                                <option value="Amenities">الصلاحيات</option>
                            </select>
                            @error('group_name')
                                <span>
                                    <small class="text-danger">{{ $message }}</small>
